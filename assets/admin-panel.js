if (window.frameElement) {
    let ytIcon = '';
    const adminlinks = 'https://cdn.arenacommerce.com/admin-help/xstore/assistant.js';  
                        ...
                        if (panelId !== 'add-section-panel') {
                            ...
                            if (panelId.match(/section-.*/gm)) {
                                ...
                                if (panelId === 'header-header' && 'header_styles' in json) {
                                    ...
                                    let selector = $(activePanel).find('*[name="settings[sections][header][settings][header_style]"]');
